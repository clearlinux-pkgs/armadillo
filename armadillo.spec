...
Version  : 9.700.2
Release  : 11
URL      : http://sourceforge.net/projects/arma/files/armadillo-9.700.2.tar.xz
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.700.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567434091
mkdir -p clr-build
pushd clr-build
