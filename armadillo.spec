...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-12.6.6.tar.xz
...
%prep
%setup -q -n armadillo-12.6.6
cd %{_builddir}/armadillo-12.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701933960
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarmadillo.so.12.6.6
/usr/lib64/libarmadillo.so.12
/usr/lib64/libarmadillo.so.12.6.6
