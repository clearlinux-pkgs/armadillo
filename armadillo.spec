...
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.800.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572614715
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-9.800.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
...
/usr/lib64/libarmadillo.so.9.800.2
