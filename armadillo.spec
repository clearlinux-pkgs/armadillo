...
Version  : 9.800.1
Release  : 13
URL      : http://sourceforge.net/projects/arma/files/armadillo-9.800.1.tar.xz
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.800.1.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570547286
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.9.800.1
