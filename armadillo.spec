...
Version  : 14.0.0
Release  : 83
URL      : https://sourceforge.net/projects/arma/files/armadillo-14.0.0.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-14.0.0.tar.xz
...
%prep
%setup -q -n armadillo-14.0.0
cd %{_builddir}/armadillo-14.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719326272
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarmadillo.so.14.0.0
/usr/lib64/libarmadillo.so.14
/usr/lib64/libarmadillo.so.14.0.0
