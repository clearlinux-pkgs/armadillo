...
Version  : 10.6.2
Release  : 34
URL      : https://sourceforge.net/projects/arma/files/armadillo-10.6.2.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-10.6.2.tar.xz
...
%prep
%setup -q -n armadillo-10.6.2
cd %{_builddir}/armadillo-10.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628173038
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-10.6.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
...
/usr/lib64/libarmadillo.so.10.6.2
