...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-10.8.2.tar.xz
...
%prep
%setup -q -n armadillo-10.8.2
cd %{_builddir}/armadillo-10.8.2
...
cp %{_builddir}/armadillo-10.8.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
