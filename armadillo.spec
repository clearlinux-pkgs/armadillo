...
Version  : 12.0.0
Release  : 63
URL      : https://sourceforge.net/projects/arma/files/armadillo-12.0.0.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-12.0.0.tar.xz
...
%prep
%setup -q -n armadillo-12.0.0
cd %{_builddir}/armadillo-12.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676915224
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.12.0.0
