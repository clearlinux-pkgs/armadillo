...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-10.8.0.tar.xz
...
%prep
%setup -q -n armadillo-10.8.0
cd %{_builddir}/armadillo-10.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641230620
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-10.8.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
...
/usr/lib64/libarmadillo.so.10.8.0
