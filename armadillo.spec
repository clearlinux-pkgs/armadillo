...
Version  : 9.400.2
Release  : 4
URL      : http://sourceforge.net/projects/arma/files/armadillo-9.400.2.tar.xz
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.400.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1556288258
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libarmadillo.so.9.400.2
