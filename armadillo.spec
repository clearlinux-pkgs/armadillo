...
Version  : 11.2.3
Release  : 52
URL      : https://sourceforge.net/projects/arma/files/armadillo-11.2.3.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.2.3.tar.xz
...
%prep
%setup -q -n armadillo-11.2.3
cd %{_builddir}/armadillo-11.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657633912
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-11.2.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libarmadillo.so.11
/usr/lib64/libarmadillo.so.11.2.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
