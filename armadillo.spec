...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.4.2.tar.xz
...
%prep
%setup -q -n armadillo-11.4.2
cd %{_builddir}/armadillo-11.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666361391
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.11.4.2
