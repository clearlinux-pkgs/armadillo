...
Version  : 11.2.4
Release  : 53
URL      : https://sourceforge.net/projects/arma/files/armadillo-11.2.4.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.2.4.tar.xz
...
%prep
%setup -q -n armadillo-11.2.4
cd %{_builddir}/armadillo-11.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662727100
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.11.2.4
