...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-14.0.1.tar.xz
...
%prep
%setup -q -n armadillo-14.0.1
cd %{_builddir}/armadillo-14.0.1
pushd ..
cp -a armadillo-14.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720449820
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarmadillo.so.14.0.1
/usr/lib64/libarmadillo.so.14
/usr/lib64/libarmadillo.so.14.0.1
