...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-12.8.0.tar.xz
...
%prep
%setup -q -n armadillo-12.8.0
cd %{_builddir}/armadillo-12.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707256387
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarmadillo.so.12.8.0
/usr/lib64/libarmadillo.so.12
/usr/lib64/libarmadillo.so.12.8.0
