...
Version  : 11.4.0
Release  : 54
URL      : https://sourceforge.net/projects/arma/files/armadillo-11.4.0.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.4.0.tar.xz
...
%prep
%setup -q -n armadillo-11.4.0
cd %{_builddir}/armadillo-11.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663856579
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.11.4.0
