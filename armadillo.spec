...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.4.3.tar.xz
...
%prep
%setup -q -n armadillo-11.4.3
cd %{_builddir}/armadillo-11.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672240379
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.11.4.3
