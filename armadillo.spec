...
Version  : 10.6.1
Release  : 33
URL      : https://sourceforge.net/projects/arma/files/armadillo-10.6.1.tar.xz
Source0  : https://sourceforge.net/projects/arma/files/armadillo-10.6.1.tar.xz
...
%prep
%setup -q -n armadillo-10.6.1
cd %{_builddir}/armadillo-10.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626721180
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-10.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
...
/usr/lib64/libarmadillo.so.10.6.1
