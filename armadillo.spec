...
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.400.4.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559225657
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libarmadillo.so.9.400.4
