...
Version  : 9.200.8
Release  : 2
URL      : http://sourceforge.net/projects/arma/files/armadillo-9.200.8.tar.xz
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.200.8.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552259367
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.9.200.8
