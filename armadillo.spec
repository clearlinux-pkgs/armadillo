...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-14.2.0.tar.xz
...
%prep
%setup -q -n armadillo-14.2.0
cd %{_builddir}/armadillo-14.2.0
pushd ..
cp -a armadillo-14.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731947138
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libarmadillo.so.14.2.0
/usr/lib64/libarmadillo.so.14
/usr/lib64/libarmadillo.so.14.2.0
