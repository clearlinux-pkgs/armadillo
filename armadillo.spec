...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-11.4.1.tar.xz
...
%prep
%setup -q -n armadillo-11.4.1
cd %{_builddir}/armadillo-11.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665411130
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.11.4.1
