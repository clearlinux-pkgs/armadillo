...
Source0  : https://sourceforge.net/projects/arma/files/armadillo-12.0.1.tar.xz
...
%prep
%setup -q -n armadillo-12.0.1
cd %{_builddir}/armadillo-12.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677078658
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libarmadillo.so.12.0.1
