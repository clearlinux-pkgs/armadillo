...
Version  : 10.2.0
Release  : 21
URL      : http://sourceforge.net/projects/arma/files/armadillo-10.2.0.tar.xz
Source0  : http://sourceforge.net/projects/arma/files/armadillo-10.2.0.tar.xz
...
%prep
%setup -q -n armadillo-10.2.0
cd %{_builddir}/armadillo-10.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611280392
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/armadillo-10.2.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/armadillo/47b573e3824cd5e02a1a3ae99e2735b49e0256e4
pushd clr-build
%make_install
popd
