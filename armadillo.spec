...
Source0  : http://sourceforge.net/projects/arma/files/armadillo-9.500.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1560262576
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libarmadillo.so.9.500.2
